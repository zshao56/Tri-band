...
def initialize_variables():
    ...
    medium_WO3_Bleach = td.PoleResidue.from_file("nk/WO3-bleach.json")
    medium_WO3_Color = td.PoleResidue.from_file("nk/WO3-coloration.json")
...
t_WO3 = 0.3
t_ITO_top= 0.03
w_WO3s = np.array([0.45, 0.55])
t_SPEs = np.array([0.55, 0.60])
folder_name = './results/WO3_ITO'
